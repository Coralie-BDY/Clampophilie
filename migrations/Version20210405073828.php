 ...
 */
final class Version20210405073828 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user DROP phone, DROP postal_code, DROP city, DROP address, DROP birthday');
    }
